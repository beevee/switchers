...
const (
	...
	responseGatheringInstructions       = "Соберитесь в указанном месте. Как только соберетесь, все одновременно должны написать \"" + commandGathered + "\"."
	...
	responseGatheringTaskSuffix         = " Как только соберетесь, одновременно напишите \"" + commandGathered + "\" в чат. Чтобы игра началась, достаточно четырех человек. Остальные не получат очки."
	responseActualTaskSuffix            = " Ответ может прислать любой участник. Засчитывается последний присланный ответ."
